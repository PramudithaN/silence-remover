# Silence Remover
![Javascript](https://img.shields.io/badge/Javascript-f1e05a?style=for-the-badge&logo=js&logoColor=f1e05a)
...
1. Open `silence-remover.html` in any modern browser
2. Drop or select an audio file
3. Adjust the sliders to your needs
